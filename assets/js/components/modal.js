...
const formModal = [
    { id: 'book-title', type: 'text', text: 'Nama' },
    { id: 'book-author', type: 'text', text: 'Umur' },
    { id: 'book-years', type: 'text', text: 'No HP' },
    { id: 'book-iscompleted', type: 'checkbox', text: 'Sudah Verifikasi Offilne' }
];
...
addBtnModal.addEventListener('click', () => {
    const modalAddBook = addBookModal(formModal, 'Daftar Peserta', {
        isEdit: false
    });
